      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyWrap}>
            ...
            <Text style={styles.emptyText}>Você será avisado aqui sobre mensagens, atualizações de pedidos e orçamentos.</Text>
          </View>
        }
        renderItem={({ item }) => (
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  itemUnread: { backgroundColor: '#FFF7F4' },
  iconWrap: {
    width: 44,
    height: 44,
    borderRadius: 22,
  ...
  iconWrapUnread: { backgroundColor: '#FFE8DC' },
