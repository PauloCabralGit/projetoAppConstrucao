...
import AdStories, { AdBanner } from '../../src/components/ads/AdStories';
import AdFullscreen from '../../src/components/ads/AdFullscreen';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.bottomCard, { backgroundColor: colors.cardWhite }]}>
        ...
        <AdStories ads={adBanners} onPress={setSelectedAd} />
        <AdFullscreen ad={selectedAd} onClose={() => setSelectedAd(null)} />
